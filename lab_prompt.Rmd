...
```{r}
actual_420_date <- co2_present$Date[which(co2_present$average > 420)[1]]

# Print the actual date vs. predicted dates
cat("Actual date when CO2 levels first crossed 420 ppm: ", actual_420_date, "\n")
cat("Predicted date from linear model: ", prediction.420.linear, "\n")
cat("Predicted date from ARIMA model: ", prediction.420.arima, "\n")
