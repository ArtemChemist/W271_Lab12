...
last.date <- function(series, num) {
  ...
  return(df_frcst_long$my_date[vec[length(vec)]])
}
...
last_time.420 <- "NA" # Hardcoded to NA since it never reaches 500ppm
...
last_time.500 <- "NA" # Hardcoded to NA since it never reaches 500ppm
