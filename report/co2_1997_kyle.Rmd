...
\textcolor{blue}{Atmospheric carbon is plotted in \autoref{fig:carbon}, and shows a clear uptrend that seems to even gain momentum in the last three decades. The CO2 ppm rose from 310 in 1960 to over 350 in the late 1990s, and over 420 today. The slope is getting steeper, so it's fair to say that the situation will get worse. It is not surprising that we hear more and more news about extreme weather patterns and excessive heat around the globe.
