...
\begin{figure}
  ...
  \begin{figurenotes}
    $CO_2$ concentration from 1974 onward continues to exhibit ever accelerating growth, with the exception of slight deceleration around 1990. Strong seasonal pattern is also present.
  \end{figurenotes}
\end{figure} 
