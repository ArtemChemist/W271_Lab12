...
We first focus on seasolly adjusted data. As a first step we will perform a grid search of the model space, looking for the ARIMA model with the lowest BIC.
